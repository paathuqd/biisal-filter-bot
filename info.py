...
#main variables
API_ID = int(environ.get('API_ID', '14119295'))
API_HASH = environ.get('API_HASH', '18a4882c679e7506fae7a70f00c68c5f')
BOT_TOKEN = environ.get('BOT_TOKEN', '7695815965:AAHpVXM5rwsyoSwONnXI26UcmcgZUrsZbTc')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7842078007').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002280897374'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pathuavi12:<db_password>@pathum.2dpgp.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002353882393.'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002264200250'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002350769406'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002327614671'))
